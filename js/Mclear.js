...
var gameState = false;
//需要加载的图像
var imageAddress = ['images/restart.png', 'images/bg2.png', 'images/defeat.gif', 'images/victory.gif'];
//已加载好的图像
var imageStart = [];
//当前加载的图像ID
var imageId = 0;
...
function GameOver(num) {
  ...
  if (num == 0) {
    ...
    $('text').style.display = 'block';
    $('Difficu').style.display = 'none';
    $('text').getElementsByTagName('img')[0].src = 'images/victory.gif';
    $('text').getElementsByTagName('p')[0].innerHTML = '太厉害了！<br />居然只用了' + formTime + '秒';
